        ...
        <Card>
          <div>
            ...
            <p className="text-sm text-zinc-400 text-justify">
              ...
              finibus turpis ac nisi mollis, quis aliquet ante ullamcorper.
              Maecenas laoreet nulla semper vulputate consectetur. Vivamus
              fringilla semper est eu placerat. Fusce ac pellentesque metus.
              Morbi a dui vitae mauris ultrices blandit nec id ex. Aenean id
              interdum lorem. Nulla facilisi. Proin ut magna neque. Sed et
              mauris nec massa luctus
              <br />
              <br />
              scelerisque. Sed maximus, turpis in finibus tempus, erat nunc
              interdum lectus, vel mattis nisl nunc posuere justo. Integer
              aliquam magna in odio commodo eleifend. Donec tincidunt augue ac
              ipsum finibus finibus. Proin semper velit sed risus congue, ut
              vulputate nisl sagittis.
            </p>
          </div>
